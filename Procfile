...
cloud_controller: sh -c 'cd cloud_controller/cloud_controller && env BUNDLE_GEMFILE=Gemfile CLOUD_CONTROLLER_CONFIG=../../config/cloud_controller/cc_config.yml bin/cloud_controller'